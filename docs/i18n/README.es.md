...
> **Producción publicada:** `anchorloop@0.2.1`
...
La versión `0.2.1` incluye recuperación, validación, modos de ownership,
...
- [Migración 0.1.0 → 0.2.1](../MIGRATION_0.2.md)
