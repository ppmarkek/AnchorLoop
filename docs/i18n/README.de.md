...
> - **Veröffentlichte Produktion:** `anchorloop@0.2.0`
> - **Aktuelle Version:** `0.2.0`
> - Verwenden Sie in Automatisierung die exakte Version:
>   `npx --yes anchorloop@0.2.0 ...`. [Migrationsanleitung](../MIGRATION_0.2.md).
